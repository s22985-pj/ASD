...
def arrayRandom2000():
    arr = []
    for i in(np.array(range(2000, 0, -1))):
        arr.append(i)
...
def arrayRandom4000():
    arr = []
    for i in(np.array(range(4000, 0, -1))):
        arr.append(i)
    f = open('Resorted.txt', 'w')
    f.write('{}'.format(arr))
    f.close()
...
def arrayRandom8000():
    arr = []
    for i in(np.array(range(8000, 0, -1))):
        arr.append(i)
    f = open('Resorted.txt', 'w')
    f.write('{}'.format(arr))
    f.close()
...
def arrayRandom16000():
    arr = []
    for i in(np.array(range(16000, 0, -1))):
        arr.append(i)
    f = open('Resorted.txt', 'w')
    f.write('{}'.format(arr))
    f.close()
...
def arrayRandom32000():
    arr = []
    for i in(np.array(range(32000, 0, -1))):
        arr.append(i)
    f = open('Resorted.txt', 'w')
    f.write('{}'.format(arr))
    f.close()
...
Fn2 = (4000*4000)/time2
Fn3 = (8000*8000)/time3
Fn4 = (16000*16000)/time4
Fn5 = (32000*32000)/time5
